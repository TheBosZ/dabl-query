...
class Condition {
   ...
   */
	...
	static QueryStatement _processCondition(Object left, [right = null, operator = Query.EQUAL, Object quote = null]) {
		...
		if (null == quote) {
			// You can skip operator and specify quote with param 3
			if (operator is num) {
				quote = operator;
		...
		//Escape left
		if(quote == QUOTE_LEFT || quote == QUOTE_BOTH) {
	...
	Condition addAnd(Object left, [right, oper = Query.EQUAL, quote = null]) {
		if (null == left) {
			return this;
		}
